...
**Approach**: Primarily unit tests with mocked external services (Mem0, Supabase, Voyage AI). Integration tests for service layer. No browser/UI tests (no frontend).
